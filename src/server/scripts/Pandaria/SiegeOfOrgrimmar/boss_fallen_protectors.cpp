    ...
    public:
        ...
        class spell_rook_corrupted_brew_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                if (caster->GetMap()->GetDifficulty() == DIFFICULTY_10MAN_HEROIC)
                    count = 2;
                else if (caster->GetMap()->GetDifficulty() == DIFFICULTY_25MAN_NORMAL)
                    count = 3;
                else if (caster->GetMap()->GetDifficulty() == DIFFICULTY_25MAN_HEROIC)
                    count = 6;
