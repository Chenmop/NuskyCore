...
public:
    ...
    struct boss_sartharionAI : public ScriptedAI
    {
        ...
        void CastLavaStrikeOnTarget(Unit* target)
        {
            ...
            Nusky::AllCreaturesOfEntryInRange checker(me, NPC_FIRE_CYCLONE, 200.0f);
            Nusky::CreatureListSearcher<Nusky::AllCreaturesOfEntryInRange> searcher(me, pFireCyclonesList, checker);
