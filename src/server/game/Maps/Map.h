...
class InstanceMap;
class Transport;
namespace Nusky { struct ObjectUpdater; }
...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<Nusky::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<Nusky::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
            return IsGridLoaded(Nusky::ComputeGridCoord(x, y));
        }
