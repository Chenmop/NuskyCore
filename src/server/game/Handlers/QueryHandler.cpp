...
void WorldSession::HandleNameQueryOpcode(WorldPacket& recvData)
{
    ...
    // NC_LOG_INFO("network", "HandleNameQueryOpcode %u", guid);
...
void WorldSession::HandleCreatureQueryOpcode(WorldPacket& recvData)
{
    ...
    if (info)
    {
        ...
        NC_LOG_DEBUG("network", "WORLD: CMSG_CREATURE_QUERY '%s' - Entry: %u.", info->Name.c_str(), entry);
        ...
        NC_LOG_DEBUG("network", "WORLD: Sent SMSG_CREATURE_QUERY_RESPONSE");
    }
    else
        NC_LOG_DEBUG("network", "WORLD: CMSG_CREATURE_QUERY - NO CREATURE INFO! (ENTRY: %u)", entry);
...
void WorldSession::HandleGameObjectQueryOpcode(WorldPacket& recvData)
{
    ...
    if (info)
    {
        ...
        NC_LOG_DEBUG("network", "WORLD: CMSG_GAMEOBJECT_QUERY '%s' - Entry: %u. ", info->name.c_str(), entry);
        ...
        NC_LOG_DEBUG("network", "WORLD: Sent SMSG_GAMEOBJECT_QUERY_RESPONSE");
    }
    else
    {
        NC_LOG_DEBUG("network", "WORLD: CMSG_GAMEOBJECT_QUERY - Missing gameobject info for (GUID: %u, ENTRY: %u)",
...
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_CORPSE_QUERY");
...
void WorldSession::HandleNpcTextQueryOpcode(WorldPacket& recvData)
{
    ...
    NC_LOG_DEBUG("network", "WORLD: CMSG_NPC_TEXT_QUERY ID '%u'", textID);
    ...
    NC_LOG_DEBUG("network", "WORLD: Sent SMSG_NPC_TEXT_UPDATE");
}

/// Only _static_ data is sent in this packet !!!
void WorldSession::HandlePageTextQueryOpcode(WorldPacket& recvData)
{
    NC_LOG_DEBUG("network", "WORLD: Received CMSG_PAGE_TEXT_QUERY");
    ...
    while (pageID)
    {
        ...
        NC_LOG_DEBUG("network", "WORLD: Sent SMSG_PAGE_TEXT_QUERY_RESPONSE");
    }
}

void WorldSession::HandleCorpseMapPositionQuery(WorldPacket& recvData)
{
    NC_LOG_DEBUG("network", "WORLD: Recv CMSG_CORPSE_MAP_POSITION_QUERY");
