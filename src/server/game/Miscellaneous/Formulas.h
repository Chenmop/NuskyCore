...
#ifndef Nusky_FORMULAS_H
#define Nusky_FORMULAS_H
        ...
        inline uint32 BaseGain(uint8 pl_level, uint8 mob_level, ContentLevels content)
        {
            ...
            switch (content)
            {
                ...
                case CONTENT_86_90:
                    ...
                    break;
                default:
                    NC_LOG_ERROR("misc", "BaseGain: Unsupported content level %u", content);
                    nBaseExp = 45;
                    break;
            }
