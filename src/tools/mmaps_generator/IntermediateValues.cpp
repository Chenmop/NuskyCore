...
#undef DEBUG_WRITE
    ...
    void IntermediateValues::generateObjFile(uint32 mapID, uint32 tileX, uint32 tileY, MeshData &meshData)
    {
        ...
        snprintf(objFileName, sizeof(objFileName), "meshes/map%04u_%02u_%02u.obj", mapID, tileY, tileX);
        ...
        snprintf(objFileName, sizeof(objFileName), "meshes/%04u.map", mapID);
        ...
        snprintf(objFileName, sizeof(objFileName), "meshes/%04u_%02u_%02u.mesh", mapID, tileY, tileX);
        objFile = fopen(objFileName, "wb");
        if (!objFile)
        {
            char message[1024];
